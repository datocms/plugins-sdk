...
import { AwesomeFontIconIdentifier } from './awesomeFont';
...
export type ItemFormDropdownActionsAdditionalProperties =
  ItemFormAdditionalProperties;

export type ItemFormDropdownActionsProperties = InitProperties &
  ItemFormDropdownActionsAdditionalProperties;

export type FieldDropdownActionsAdditionalProperties =
  ItemFormAdditionalProperties & FieldAdditionalProperties;

export type FieldDropdownActionsProperties = InitProperties &
  FieldDropdownActionsAdditionalProperties;

export type ExecuteItemFormDropdownActionAdditionalProperties =
  ItemFormAdditionalProperties & {
    parameters: Record<string, unknown> | undefined;
  };

export type ExecuteItemFormDropdownActionProperties = OnBootProperties &
  ExecuteItemFormDropdownActionAdditionalProperties;

export type ExecuteItemFormDropdownActionAdditionalMethods =
  ItemFormAdditionalMethods;

export type ExecuteItemFormDropdownActionMethods = OnBootMethods &
  ExecuteItemFormDropdownActionAdditionalMethods;

export type ExecuteItemFormDropdownActionPropertiesAndMethods =
  ExecuteItemFormDropdownActionProperties &
    ExecuteItemFormDropdownActionMethods;

export type ExecuteFieldDropdownActionAdditionalProperties =
  ItemFormAdditionalProperties &
    FieldAdditionalProperties & {
      parameters: Record<string, unknown> | undefined;
    };

export type ExecuteFieldDropdownActionProperties = OnBootProperties &
  ExecuteFieldDropdownActionAdditionalProperties;

export type ExecuteFieldDropdownActionAdditionalMethods =
  ItemFormAdditionalMethods;

export type ExecuteFieldDropdownActionMethods = OnBootMethods &
  ExecuteFieldDropdownActionAdditionalMethods;

export type ExecuteFieldDropdownActionPropertiesAndMethods =
  ExecuteFieldDropdownActionProperties & ExecuteFieldDropdownActionMethods;

export type ExecuteItemsDropdownActionAdditionalProperties = {
  parameters: Record<string, unknown> | undefined;
};

export type ExecuteItemsDropdownActionProperties = OnBootProperties &
  ExecuteItemsDropdownActionAdditionalProperties;

export type ExecuteItemsDropdownActionMethods = OnBootMethods;

export type ExecuteItemsDropdownActionPropertiesAndMethods =
  ExecuteItemsDropdownActionProperties & ExecuteItemsDropdownActionMethods;

export type ExecuteUploadsDropdownActionAdditionalProperties = {
  parameters: Record<string, unknown> | undefined;
};

export type ExecuteUploadsDropdownActionProperties = OnBootProperties &
  ExecuteUploadsDropdownActionAdditionalProperties;

export type ExecuteUploadsDropdownActionMethods = OnBootMethods;

export type ExecuteUploadsDropdownActionPropertiesAndMethods =
  ExecuteUploadsDropdownActionProperties & ExecuteUploadsDropdownActionMethods;

/** Information regarding the specific outlet that you need to render */
export type RenderItemCollectionOutletAdditionalProperties = {
  mode: 'renderItemCollectionOutlet';
  /** The ID of the outlet that needs to be rendered */
  itemCollectionOutletId: string;
};

export type RenderItemCollectionOutletProperties = RenderProperties &
  RenderItemCollectionOutletAdditionalProperties;

export type RenderItemCollectionOutletAdditionalMethods = {
  getSettings: () => Promise<RenderItemCollectionOutletProperties>;
};

export type RenderItemCollectionOutletMethods = RenderMethods &
  IframeMethods &
  RenderItemCollectionOutletAdditionalMethods;

export type RenderItemCollectionOutletPropertiesAndMethods =
  RenderItemCollectionOutletMethods & RenderItemCollectionOutletProperties;
